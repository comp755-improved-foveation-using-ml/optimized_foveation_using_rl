# Sample image compressor using SVD borrowed from: https://github.com/Harkirat94/svd-based-image-compression
import numpy as np
import cv2
...
print("Original file byte size:", img.nbytes)
print("Compressed file byte size:", re_image.nbytes)
